...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 16 12:13:33 2019
...
def skinMask(frame, x0, y0, width, height, framecount, plot):
    ...
    if saveImg == True:
        ...
        t = threading.Thread(target=recoNN.guessGesture, args = [mod, res])
        t.start()
#    elif visualize == True:
#        layer = int(input("Enter which layer to visualize "))
#        cv2.waitKey(0)
#        recoNN.visualizeLayers(mod, res, layer)
#        visualize = False
#    
    return res
